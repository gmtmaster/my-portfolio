...
import LogoWall from "../components/logoWall.tsx";
            ...
            <div className="max-w-5xl mx-auto space-y-8 md:py-36 pb-14">
                <div className="text-left space-y-4">
                    <p className="text-md md:text-lg text-[var(--white-icon)] shiny-white">
                        Hi, Adam Lekrinszki here! I'm a <span className="text-[var(--sec)] shiny-sec">full-stack</span> developer based in Europe.
                    </p>
                    <div
                        className="flex flex-col lg:flex-row lg:items-center space-y-4 lg:space-y-0 lg:space-x-8 md:gap-4"
                    >
                        <h1
                            className="text-[var(--white)] text-5xl md:text-6xl font-medium text-pretty leading-none"
                        >
                            Software <br/> <span className="bg-gradient-to-b from-purple-500 via-purple-700 to-purple-900 bg-clip-text text-transparent">Developer</span>
                        </h1>
                        <p className="text-md md:text-2xl text-[var(--white-icon)]">
                            Transforming ideas into interactive and seamless digital experiences
                            with cutting-edge <span className="text-[var(--sec)] shiny-sec"
                        >frontend</span
                        > development.
                        </p>
                    </div>
                    <div className="flex justify-start gap-2 pt-3 md:pt-6">
                        <a
                            target="_blank"
                            href="https://github.com/gmtmaster"
                            aria-label="GitHub"
                ...
                <div className="flex flex-col lg:flex-row items-center gap-8">
                    ...
                    <div
                        className="flex justify-center md:w-full md:h-[292px] size-[290px] pt-3 md:pt-9 md:ml-16"
                    >
                        <LetterGlitch
                            client:load
