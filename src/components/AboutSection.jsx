...
function AboutSection() {
    ...
    return (
       <section ref={sectionRef} className="h-screen relative overflow-hidden bg-gradient-to-b from-black to-[#9a74cf50]">
           ...
           <div className="absolute inset-0 oveflow-hidden">
               {/*Stars*/}
               {[...Array(10)].map((_,i) => (
                <div
                    ref={addToStars}
           ...
           <div className="container mx-auto px-4 py-16 h-full flex flex-col items-center justify-center">
                <h1 ref={titleRef} className="text-4xl font-bold md:text-6xl sm:mb-16 text-center text-white opacity-0">
                    About Me
                </h1>
            </div>
           ...
           <div ref={introRef} className="absolute lg:bottom-[-20rem] md:bottom-[-10rem] bottom-[-20rem] left-0 w-full flex md:flex-row flex-col justify-between lg:px-24 px-5 items-center opacity-0">
               <h3 className="text-sm mdÍ:text-2xl font-bold text-purple-300 z-50 lg:max-w-[45rm] max-w-[27rem] tracking-wider md:mt-20 sm:mt-[-40rem] mt-[-32rem]">
               ...
               <img className="lg:h-[40rem] md:h-[25rem] [20rem] mix-blend-lighten" src="images/person.png" alt="profile"/>
           </div>
       </section>
    );
}
